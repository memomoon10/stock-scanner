...
# تعريف تطبيق فلاسك أولاً وقبل أي استخدام لـ @app.route
app = Flask(__name__)
...
# --- وظيفة بوت التحليل الشامل عند طلب السهم ---
...
# --- وظيفة المراقبة التلقائية (تجري في الخلفية) ---
def monitor_stocks():
...
if __name__ == "__main__":
    ...
    # تشغيل سيرفر الويب لاستقبال أوامر التحليل وقراءة المنفذ الديناميكي من Railway
